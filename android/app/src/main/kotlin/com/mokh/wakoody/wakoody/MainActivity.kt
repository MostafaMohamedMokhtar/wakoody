package com.mokh.wakoody.wakoody
...
class MainActivity: FlutterActivity() {
    private  val CHANNEL = "com.mokh.getMac";
    ...
    private fun getMacAddress(): String? {
        try {
            ...
            for (nif in all) {
                ...
                val macBytes: ByteArray = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                    nif.getHardwareAddress() ?: return ""
                } else {
